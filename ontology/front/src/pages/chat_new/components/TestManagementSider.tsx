...
import emptyIcon from "@/pages/chat_new/images/empty.svg";
import caseIcon from "@/pages/chat_new/images/case.svg";
import noCaseIcon from "@/pages/chat_new/images/no_case_chat.svg";
                    ...
                    {/* 展开状态的标题栏 */}
                        <div className="sider-title-row">
                            <div style={{ display: 'flex', alignItems: 'center',width: '100%'}}>
                                <Tooltip content={ontologyData.ontologyLabel}>
                                    <span className='sider-title'>
                                        {ontologyData.ontologyLabel}
                                    </span>
                                </Tooltip>
                            </div>
