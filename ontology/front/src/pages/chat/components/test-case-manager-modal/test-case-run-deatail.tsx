...
import './index.less'; 
import GraphPanel from '@/pages/chat/components/GraphPanel';
import AIMessage from '@/pages/chat/components/AIMessage'; 
import {IconDataDirColor} from 'modo-design/icon';
import {compareResult,batchTestCaseList,getSessionHistory,getGraph} from '@/pages/chat/api'
