...
// other
'${colPiece}', '${groupPiece}', '${condiPiece}',
'${COLPIECE}', '${GROUPPIECE}', '${CONDIPIECE}',
'SET SCHEMA']);
...
const reservedPhrases = expandPhrases(['ON {UPDATE | DELETE} [SET NULL | SET DEFAULT]', '{ROWS | RANGE} BETWEEN', '${colPiece}', '${groupPiece}', '${condiPiece}', '${COLPIECE}', '${GROUPPIECE}', '${CONDIPIECE}',]);
