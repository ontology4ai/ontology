...
EXEC_JAR="$PLUGIN_PATH/plugins/$FLINK_CATEGORY/$FLINK_VERSION/modo-links-flink-1.13.jar"
MAIN_CLASS="com.asiainfo.modo.links.dsx.flink.FlinkSqlExecutor"
